...
class Application {
    ...
    config() {
        ...
        __classPrivateFieldGet(this, _Application_express, "f").use(express_1.default.urlencoded({
            extended: false
        }));
        __classPrivateFieldGet(this, _Application_express, "f").use((0, cors_1.default)());
    }
    middlewares() {
        __classPrivateFieldGet(this, _Application_express, "f").use(global_1.logMiddleware, global_1.checkEnvironmentVariables);
    }
    errors() {
